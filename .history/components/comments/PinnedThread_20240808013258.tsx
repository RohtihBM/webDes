...
import { Thread } from "@liveblocks/react-ui"; // Updated import

type Props = {
  thread: ThreadData; // Adjusted type if ThreadMetadata is no longer used
...
export const PinnedThread = ({ thread, onFocus, ...props }: Props) => {
  ...
  const memoizedContent = useMemo(
    ...
    [props, minimized, thread, onFocus]
  );
